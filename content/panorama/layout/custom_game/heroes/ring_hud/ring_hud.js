var parentHUDElements = FindDotaHudElement("AbilitiesAndStatBranch");
$("#ButtonRingHud").SetParent(parentHUDElements.FindChildrenWithClassTraverse("LeftRightFlow")[0]);

var button_ring =  FindDotaHudElement("AbilitiesAndStatBranch").FindChildrenWithClassTraverse("LeftRightFlow")[0].FindChildTraverse("ButtonRingHud").FindChildTraverse("ButtonRingHud_b")
var button_ring_2 =  FindDotaHudElement("AbilitiesAndStatBranch").FindChildrenWithClassTraverse("LeftRightFlow")[0].FindChildTraverse("ButtonRingHud")

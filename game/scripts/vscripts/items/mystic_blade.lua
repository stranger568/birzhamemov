LinkLuaModifier("modifier_item_mystic_blade_custom", "items/mystic_blade.lua", LUA_MODIFIER_MOTION_NONE)
...
item_mystic_blade_custom = class({})

function item_mystic_blade_custom:GetIntrinsicModifierName()
    return "modifier_item_mystic_blade_custom"
end

function item_mystic_blade_custom:OnSpellStart()
    ...
    local projectile =
    {
        ...
        Source              = self.caster,
        Ability             = self,
        EffectName          = "particles/mystic_eal_blade.vpcf",
...
function item_mystic_blade_custom:OnProjectileHit(target, location)
    if not IsServer() then return end
...
modifier_item_mystic_blade_custom = class({})
function modifier_item_mystic_blade_custom:IsHidden() return true end
function modifier_item_mystic_blade_custom:IsPurgable() return false end
function modifier_item_mystic_blade_custom:RemoveOnDeath() return false end

function modifier_item_mystic_blade_custom:DeclareFunctions()
    return 
    {
...
function modifier_item_mystic_blade_custom:GetModifierBonusStats_Strength()
    if self:GetAbility() then
        return self:GetAbility():GetSpecialValueFor("bonus_strength")
    end
end

function modifier_item_mystic_blade_custom:GetModifierBonusStats_Agility()
    if self:GetAbility() then
        return self:GetAbility():GetSpecialValueFor("bonus_agility")
    end
end

function modifier_item_mystic_blade_custom:GetModifierBonusStats_Intellect()
    if self:GetAbility() then

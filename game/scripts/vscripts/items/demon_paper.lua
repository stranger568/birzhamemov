...
function modifier_item_demon_paper_active:GetModifierProcAttack_BonusDamage_Pure(params)
    return params.original_damage
end

function modifier_item_demon_paper_active:GetModifierDamageOutgoing_Percentage()
	return -100
end
-- item_demon_paper = class({})
-- 

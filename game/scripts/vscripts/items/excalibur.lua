...
function modifier_item_excalibur:IsHidden() return true end
function modifier_item_excalibur:IsPurgable() return false end
function modifier_item_excalibur:IsPurgeException() return false end
function modifier_item_excalibur:GetAttributes()  return MODIFIER_ATTRIBUTE_MULTIPLE end
...
function modifier_item_excalibur:OnAttackLanded(params)

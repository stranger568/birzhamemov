...
function InitAbilityAang(){
    ...
    if ($("#AangButton")) {
        ...
        button = $.GetContextPanel().GetParent().GetParent().GetParent().FindChild("HUDElements").FindChildTraverse("Ability5").FindChildTraverse("AangButton")
    }
    ...
    if (hero === "npc_dota_hero_oracle") {
        var parentHUDElements = $.GetContextPanel().GetParent().GetParent().GetParent().FindChild("HUDElements").FindChildTraverse("Ability5");
...
function InitAbilityKakashi(){
    ...
    if ($("#KakashiButton")) {
        ...
        button_kakashi = $.GetContextPanel().GetParent().GetParent().GetParent().FindChild("HUDElements").FindChildTraverse("Ability5").FindChildTraverse("KakashiButton")
    }

...
function modifier_hookah_passive:OnCreated()
	...
	self.manacost_reduce = self:GetAbility():GetSpecialValueFor("manacost_reduce")
	self.mana_regen_passive = self:GetAbility():GetSpecialValueFor("mana_regen_passive")
end
...
function modifier_hookah_passive:GetModifierPercentageManacost()
	return self.manacost_reduce end

function modifier_hookah_passive:GetModifierConstantManaRegen()
	return self.mana_regen_passive end
